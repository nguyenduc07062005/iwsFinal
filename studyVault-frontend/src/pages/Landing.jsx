            ...
            <div className="mt-20 grid gap-6 sm:grid-cols-2">
              {landingFeatures.map((f) => {
                ...
                return (
                  <article
                    key={f.title}
                    className="group relative overflow-hidden rounded-[2.5rem] border border-slate-100 bg-white p-10 transition-all hover:border-brand-200/50 hover:shadow-sks-heavy"
                  >
            ...
            <div className="grid gap-20 lg:grid-cols-2">
              ...
              <div>
                ...
                <div className="mt-10 space-y-4">
                  {landingFaq.map((item) => (
                    <details key={item.question} className="group rounded-2xl border border-slate-100 bg-white transition-all hover:border-brand-200/50">
