  ...
  return (
    <label className={cn('flex w-full flex-col gap-2', wrapperClassName)}>
      ...
      <span className="relative">
        ...
        <textarea
          className={cn(
            'control-surface min-h-28 w-full resize-none rounded-[1.45rem] px-4 py-3.5 text-sm font-semibold text-slate-800 outline-none transition-all duration-300 focus:border-brand-200 focus:bg-white focus:shadow-[var(--shadow-medium)] focus:ring-2 focus:ring-brand-500/15',
            icon && 'pl-12',
            error &&
